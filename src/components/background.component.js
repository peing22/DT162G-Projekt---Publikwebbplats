...
export default function Background() {
    ...
    return (
        <article className="background">
            ...
            <p>Träningen av våra muskler behöver ske struktu&shy;rerat, på rätt nivå och med rätt svårig&shy;hets&shy;grad för att ge önskad effekt. Denna webbplats innehåller olika <Link to="/ovningar">övningar</Link> som du kan utföra i hemmet eller på gymmet för att uppnå ditt mål.</p>
        </article>
    );
}