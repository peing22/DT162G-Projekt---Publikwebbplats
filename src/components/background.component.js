...
export default function Background() {
    ...
    return (
        <article className="background">
            <h1>Bakgrund</h1>
            <p>Vi människor är skapade för rörelse. Våra kroppar har sett ut ungefär som de gör idag i cirka 18 000-25 000 års tid. De senaste åren har vårt levnadssätt dock förändrats drastiskt till det sämre, då vi har blivit allt mer stillasittande. Vår brist på rörelse påverkar oss inte bara för stunden utan också våra liv på längre sikt.</p>
