...
export default function Background() {
    ...
    return (
        <article className="background">
            ...
            <p>Träningen av våra muskler behöver ske strukturerat, på rätt nivå och med rätt svårighetsgrad för att generera beskrivna fördelar. Denna webbplats innehåller olika övningar som du kan utföra regelbundet, i hemmet eller på gym, för att uppnå önskad effekt.</p>
        </article>
    );
}