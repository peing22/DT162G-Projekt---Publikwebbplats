...
export default function Contact() {
    ...
    return (
        <article className="contact">
            <h1>Kontakt</h1>
            <p>"Träna för att leva" är ett koncept som jag, Per Ingemarsson, har arbetat fram för att främja god hälsa och livs&shy;kvalitet hos människor. Jag arbetar som fysio&shy;terapeut och har ett stort hjärta för mitt jobb och för de människor jag möter!</p>
            <p>Min breda kunskap och gedigna erfarenhet omfattar olika aspekter av fysisk aktivitet, från rehabili&shy;tering efter skador till före&shy;byggande övningar för att främja långsiktig hälsa.</p>
